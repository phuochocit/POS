...
namespace POS_System
{
    public partial class frmOrder : Form
    {
        ...
        {
            // Tạo bảng lưu sản phẩm đã chọn
            selectedProductsTable = new DataTable();
            selectedProductsTable.Columns.Add("Tên SP", typeof(string));
            selectedProductsTable.Columns.Add("Giá", typeof(int));
            selectedProductsTable.Columns.Add("SL", typeof(int));
            selectedProductsTable.Columns.Add("Thành tiền", typeof(int));
            selectedProductsTable.Columns.Add("Size", typeof(string));
            selectedProductsTable.Columns.Add("Ghi chú", typeof(string));
        ...
        private void UpdateTotalItems()
        {
            ...
            lbl_SL.Text = totalItems > 0 ? totalItems.ToString() : "0";
        }
        ...
        private void btn_Thanhtoan_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(tongTienChuoi, out int tongTien) && tongTien > 0)
            {
                ...
                frmPay thanhToanForm = new frmPay(tongTien.ToString("N0") + " VND", tienBangChu, khach, sl, this); //selectedProductsTable
